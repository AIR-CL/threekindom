...
!function (e, t) {
    ...
    var e, L = (function (e) {
        ...
        "undefined" != typeof window && (i = (t = window).HTMLCanvasElement && t.HTMLCanvasElement.prototype, u = t.Blob && function () {
            ...
            return u ? new Blob([f ? l : o], {type: r}) : ((c = new h).append(o), c.getBlob(r))
    ...
    }(e = {exports: {}}, e.exports), e.exports), n = {
        strict: !0,
        checkOrientation: !0,
        maxWidth: 1 / 0,
        maxHeight: 1 / 0,
        ...
        success: null,
        error: null
    }, o = "undefined" != typeof window && void 0 !== window.document ? window : {}, c = Array.prototype.slice;
    var r = /^image\/.+$/;
    ...
    function f(e) {
        ...
        try {
            var a, i, n;
            if (255 === r.getUint8(0) && 216 === r.getUint8(1)) for (var o = r.byteLength, l = 2; l + 1 < o;) {
            ...
            if (n) {
                ...
                for (h = 0; h < d; h += 1) if (f = n + 12 * h + 2, 274 === r.getUint16(f, a)) {
    ...
    var h = o.ArrayBuffer, d = o.FileReader, m = o.URL || o.webkitURL, p = /\.\w+$/, g = o.Compressor;
    return function () {
        function r(e, t) {
            !function (e, t) {
        ...
        return function (e, t, r) {
            ...
            key: "init", value: function () {
                var i = this, n = this.file, e = this.options;
                if (function (e) {
                    return "undefined" != typeof Blob && (e instanceof Blob || "[object Blob]" === Object.prototype.toString.call(e))
                }(n)) {
                    var o = n.type;
                    if (P(o)) if (m && d) if (h || (e.checkOrientation = !1), m && !e.checkOrientation) this.load({url: m.createObjectURL(n)}); else {
                        var t = new d, l = e.checkOrientation && "image/jpeg" === o;
            ...
            key: "load", value: function (e) {
                ...
                a.onload = function () {
                    t.draw(i({}, e, {naturalWidth: a.naturalWidth, naturalHeight: a.naturalHeight}))
                }, a.onabort = function () {
            ...
            key: "draw", value: function (e) {
                var t = this, r = e.naturalWidth, a = e.naturalHeight, i = e.rotate, n = void 0 === i ? 0 : i,
                    o = e.scaleX, l = void 0 === o ? 1 : o, s = e.scaleY, c = void 0 === s ? 1 : s, u = this.file,
                    f = this.image, h = this.options, d = document.createElement("canvas"), b = d.getContext("2d"),
                    m = r / a, p = Math.abs(n) % 180 == 90, g = Math.max(h.maxWidth, 0) || 1 / 0,
                    v = Math.max(h.maxHeight, 0) || 1 / 0, y = Math.max(h.minWidth, 0) || 0,
                    w = Math.max(h.minHeight, 0) || 0, O = Math.max(h.width, 0) || r, U = Math.max(h.height, 0) || a;
                if (p) {
                    var B = [v, g];
                    g = B[0], v = B[1];
                    var j = [w, y];
                ...
                var x = -(O = Math.floor(C(Math.min(Math.max(O, y), g)))) / 2,
                    A = -(U = Math.floor(C(Math.min(Math.max(U, w), v)))) / 2, M = O, T = U;
                if (p) {
                    var R = [U, O];
                    O = R[0], U = R[1]
                }
            ...
            key: "done", value: function (e) {
                var t = e.naturalWidth, r = e.naturalHeight, a = e.result, i = this.file, n = this.image,
                    o = this.options;
                if (m && !o.checkOrientation && m.revokeObjectURL(n.src), a) if (o.strict && a.size > i.size && o.mimeType === i.type && !(o.width > t || o.height > r || o.minWidth > t || o.minHeight > r)) a = i; else {
                    var l = new Date;
